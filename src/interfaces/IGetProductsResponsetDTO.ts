...
export interface IGetProductsResponseDTO {
  ...
  descripcionRespuesta: string; // Descripción de la respuesta ej: (la consulta de productos ha sido exitosa)
  productos: ICreateProductsResponseDTO[]; // Retorna Lista de productos
}